<template>
  <div class="login">
    <button
      class="absolute flex items-center mb-16 bg-blue-800 w-4/6 justify-center py-2 rounded-full max-w-xl shadow-xl hover:bg-blue-700 lg:w-1/2"
      @click="loginFacebook"
    >
    ...
    <button
      class="absolute flex items-center mt-16 bg-blue-800 w-4/6 justify-center py-2 rounded-full max-w-xl shadow-xl hover:bg-blue-700 lg:w-1/2"
      @click="loginGoogle"
    >
      <span class="mr-2 uppercase text-white">Log In</span>
      <span>
        <img class="w-8 rounded" src="~/assets/img/google.svg" alt="Google icon" />
      </span>
    </button>
